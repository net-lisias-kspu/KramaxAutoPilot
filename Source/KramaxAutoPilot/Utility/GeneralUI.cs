...
namespace Kramax.Utility
{
    ...
    static class GeneralUI
    {
        ...
        public static Color InActiveBackground = XKCDColors.BrightOrange;
        public static Color ActiveBackground = XKCDColors.BrightSkyBlue;
        ...
        public static void customSkin()
        {
            ...
            // style for totally transparent window
            UISkin.customStyles[(int)myStyles.txWindow] = new GUIStyle(GUI.skin.box);
            ...
            // style for the CDI text (green)
            UISkin.customStyles[(int)myStyles.cdiLabel] = new GUIStyle(GUI.skin.box);
            UISkin.customStyles[(int)myStyles.cdiLabel].normal.textColor = XKCDColors.NeonGreen;
            UISkin.customStyles[(int)myStyles.cdiLabel].fontSize = 12;
            UISkin.customStyles[(int)myStyles.cdiLabel].alignment = TextAnchor.MiddleCenter;
            ...
            UISkin.customStyles[(int)myStyles.leftButtonText] = new GUIStyle(UISkin.button);
            UISkin.customStyles[(int)myStyles.leftButtonText].alignment = TextAnchor.MiddleLeft;
        }
